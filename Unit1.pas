...
edit1.Enabled:=True;
edit2.Enabled:=True;
 MessageDlg('Не удалось подключиться. Попробуйте изменить IP в настройках. (Код ошибки: '+IntToStr(Errorcode)+')',mterror,[mbok],0);
 errorcode:=0;
 end;
...
begin
  ...
  form2.ListView1.Items.Add.Caption:='Общий чат';
...
begin
Client.Active:=false;
ShowMessage('Поздравляем, Вы успешно зарегистрировались! Нажмите кнопку "Войти".');
button1.Enabled:=True;
button2.Enabled:=True;
edit1.Enabled:=True;
edit2.Enabled:=True;
...
begin
Delete(s,1,2);
if form2.BitBtn1.Caption='Онлайн' then
begin
client.Socket.SendText('#H'+'6'+form1.Edit1.Text+'|');
end;
if form2.BitBtn1.Caption='Кушаю' then
begin
client.Socket.SendText('#H'+'2'+form1.Edit1.Text+'|');
end;
if form2.BitBtn1.Caption='Злой' then
begin
client.Socket.SendText('#H'+'1'+form1.Edit1.Text+'|');
end;
if form2.BitBtn1.Caption='Недоступен' then
begin
client.Socket.SendText('#H'+'3'+form1.Edit1.Text+'|');
end;
if form2.BitBtn1.Caption='Отошел' then
begin
client.Socket.SendText('#H'+'0'+form1.Edit1.Text+'|');
end;
if form2.BitBtn1.Caption='Занят' then
begin
